...
public class VerificationToken {
    ...
    @JoinColumn(nullable = false, name = "id_customer", foreignKey = @ForeignKey(name = "FK_VERIFY_USER"))
    ...
    public VerificationToken(final String token, final User customerEntity) {
        super();
    ...
    public void setCustomerEntity(final User customerEntity) {
        this.customerEntity = customerEntity;
    }
